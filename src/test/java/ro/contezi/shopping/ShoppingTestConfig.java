...
public class ShoppingTestConfig {
    ...
    public static String mesageFromUser(String message, String facebookPageUserId) {
    ...
    public static String quickReplyFromUser(String payload, String facebookPageUserId) {
